...
const BODY = [
  ...
  "You are not permitted to make direct contact with the Vendor, the Vendor's employees, or the Vendor's suppliers. All communications with the Vendor or requests for information from the Vendor, as well as arrangement of inspections must be conducted through ABBASS Business Brokers.",
  ...
  'To the extent permitted by law, ABBASS Business Brokers and its representatives expressly disclaim all liability, whether direct or indirect, arising from or purporting to arise from reliance on the contents of this report or any subsequent files or documents.',
];
...
export function ConfidentialitySection() {
  return (
    <div className="relative">
      ...
      <h3 className="mb-4 text-lg font-semibold text-brand-primary">Conditions of Acceptance</h3>
      ...
      <div className="mt-8 border-t border-gray-200 pt-4 text-sm text-gray-400">
        <p className="font-semibold text-gray-600">ABBASS Business Brokers</p>
