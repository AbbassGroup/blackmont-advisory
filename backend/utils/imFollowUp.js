...
function buildFollowUpEmail({ enquiry, businessName, brokerName, interestedUrl, browseUrl }) {
  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:600px;color:#333">
      ...
      <p style="margin-top:28px">${signatureName}<br/>Blackmont Advisory<br/><a href="mailto:info@blackmontadvisory.com">info@blackmontadvisory.com</a><br/><a href="https://www.blackmontadvisory.com">www.blackmontadvisory.com</a></p>
    </div>`;
