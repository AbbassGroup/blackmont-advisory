...
const SOCIALS = [
  { icon: Globe, href: 'https://abbass.com.au/businessbrokers', label: 'Website' },
  { icon: Instagram, href: 'https://instagram.com/abbassbusinessbrokers', label: 'Instagram' },
  { icon: Facebook, href: 'https://facebook.com/abbassbusinessbrokers', label: 'Facebook' },
  { icon: Linkedin, href: 'https://www.linkedin.com/company/abbassbusinessbrokers/', label: 'LinkedIn' },
];
  ...
  return (
    <div className="relative">
      ...
      <p className="max-w-3xl text-[0.95rem] leading-relaxed text-gray-500">
        At ABBASS Business Brokers, we specialise in facilitating the seamless sale and acquisition
        of businesses across Australia. With deep market knowledge and a personalised approach, we
        guide business owners and aspiring business owners through every step of the process,
        ensuring that transactions are smooth, efficient, and successful. Whether you&apos;re looking
        to sell your business or invest in a new opportunity, our team is dedicated to helping you
        achieve your goals with confidence and ease.
      </p>

      <p className="mt-7 font-semibold text-brand-black">We help business owners with:</p>
