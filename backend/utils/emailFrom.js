...
// Wraps a bare address (e.g. info@abbass.group) as "ABBASS Group <info@abbass.group>".
...
const FROM_EMAIL = process.env.EMAIL_FROM || process.env.EMAIL_USER || 'info@abbass.group';
