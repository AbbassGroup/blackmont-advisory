...
export function FranchiseHero() {
  return (
    <section className='relative pt-[80px] bg-brand-black text-white min-h-[600px] flex items-center overflow-hidden'>
      ...
      <div className='max-w-[1260px] mx-auto px-6 lg:px-8 py-16 relative z-10 w-full'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
          ...
          <motion.div
            ...
            className='relative max-w-[440px] w-full mx-auto lg:mx-0 lg:ml-auto'
          >
            <div className='relative rounded-3xl overflow-hidden shadow-[0_12px_40px_rgba(86,193,188,0.2)] aspect-[4/5]'>
              <Image
                src='/businessbrokers/IMG_3391.webp'
                alt='Sadeq Abbass'
                fill
