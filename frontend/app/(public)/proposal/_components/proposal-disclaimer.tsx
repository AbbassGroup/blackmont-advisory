    ...
    <div className='mt-8 mb-12 bg-transparent shadow-none'>
      ...
      <div className='mb-8 space-y-4'>
        ...
        <p className='text-muted-foreground leading-relaxed'>
          ...
          publicly available sources at the date of this appraisal. Blackmont
          Advisory endeavours to make all reasonable inquiries but it is not
          responsible for determining the accuracy or completeness of
      ...
      <div className='pt-2'>
        <p className='font-bold text-secondary'>Blackmont Advisory</p>
        <p className='text-sm text-muted-foreground mt-1'>ABN: 78 674 429 255</p>
        <p className='text-sm text-muted-foreground'>License (BLA) 092153L</p>
      </div>
    </div>
  );
}
